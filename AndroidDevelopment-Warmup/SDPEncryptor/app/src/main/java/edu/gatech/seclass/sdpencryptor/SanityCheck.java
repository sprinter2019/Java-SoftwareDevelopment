...
public class SanityCheck {
    ...
    SDPEncryptorActivity tester = null;

    int test1 = R.id.messageInput;
    int test2 = R.id.incrementNumber;
    int test3 = R.id.keyNumber;
    int test4 = R.id.encryptButton;
    int test5 = R.id.cipherText;
